...
The UI component uses the JavaFX UI framework. The layout of [`MainWindow`](../src/ruby/keyboardwarrior/ui/MainWindow.java) is defined in the matching â€œ.fxmlâ€? file that is located in `keyboardwarrior/ui/` folder, i.e. [`mainwindow.fxml`](../src/ruby/keyboardwarrior/ui/mainwindow.fxml).

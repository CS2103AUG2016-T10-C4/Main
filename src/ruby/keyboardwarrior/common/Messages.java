...
public class Messages {
    ...
    public static final String MESSAGE_TASK_NOT_IN_TASKSLIST = "Task could not be found in taskslist";
    public static final String MESSAGE_TASKS_LISTED_OVERVIEW = "%1$d items listed!";
